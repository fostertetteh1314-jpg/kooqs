...
export default function CheckoutPage() {
  ...
  async function initiatePayment() {
    ...
    try {
      ...
      if (data.code === "TP14" || data.status === 1) {
        setPayStep("otp");
        ...
        <main className="max-w-md mx-auto px-4 py-10 text-center">
          <div className="card p-7">
            ...
            <p className="text-kooqs-text-dim text-sm mb-5">
              ...
              Enter it below to approve the{" "}
              <span className="text-white font-bold">{formatPrice(total)}</span> payment.
            </p>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="card p-5">
              ...
              <p className="text-kooqs-text-dim text-sm leading-relaxed">
                Enter your MTN number. You&apos;ll receive an OTP via SMS to approve the{" "}
